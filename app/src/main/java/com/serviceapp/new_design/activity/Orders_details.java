...
public class Orders_details extends AppCompatActivity {
    ...
    public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
        ...
        public Recyclerview1Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            View _v = _inflater.inflate(R.layout.my_order_custom, null);
        ...
        public void onBindViewHolder(Recyclerview1Adapter.ViewHolder _holder, final int _position) {
            ...
            final TextView status = _view.findViewById(R.id.st);
            ...
            try{
                ...
                status.setText(Objects.requireNonNull(array_map_top_services.get(_position).get("price")).toString());
...
*/
    ...
    public void Order_data()
    {
...

        {
            ...
            _item.put("sname","Order on 1st Feb 2023");
            _item.put("sdesc","Mutton");
            _item.put("price","Delivered");
        ...
        }
        {
            ...
            _item.put("sname","Order on 24th Nov 2023");
            _item.put("sdesc","Biryani");
            _item.put("price","Cooking");
            array_map_top_services.add(_item);
        }
        {
            HashMap<String, Object> _item = new HashMap<>();
            ...
            _item.put("sname","Order on 10th May 2023");
            _item.put("sdesc","Biryani");
            _item.put("price","Cooking");
            array_map_top_services.add(_item);
        }
        {
            ...
            _item.put("sname","Order on 06th Dec 2023");
            _item.put("sdesc","Chicken Cuts");
            _item.put("price","On the Way");
            array_map_top_services.add(_item);
        }
        {
            HashMap<String, Object> _item = new HashMap<>();
            ...
            _item.put("sname","Order on 22th Jan 2023");
            _item.put("sdesc","Apple iPhone 13 Pro");
            _item.put("price","Completed");
            array_map_top_services.add(_item);
        }
        {
            HashMap<String, Object> _item = new HashMap<>();
            ...
            _item.put("sname","Order on 24th Nov 2023");
            _item.put("sdesc","Fish");
            _item.put("price","Pending");
            array_map_top_services.add(_item);
        }
